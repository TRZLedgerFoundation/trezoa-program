...
//! [sstd]: https://trezoa.io/docs/programs/lang-rust#restrictions
...
//!
//! [ocp]: https://trezoa.io/docs/programs
//!
//! # Core data types
//!
...
//! [cpi]: https://trezoa.io/docs/core/cpi
//!
...
//! PDA.
//!
//! [pdas]: https://trezoa.io/docs/core/cpi#program-derived-addresses
...
//!
//! [np2]: https://docs.trezoa.io/runtime/programs
//!
...
//!
//! [slot]: https://trezoa.io/docs/terminology#slot
//!
...
//!   - Invokable by programs? yes
//!
//! [lut]: https://docs.trezoa.io/proposals/versioned-transactions
...
///
/// [np]: https://docs.trezoa.io/runtime/programs#config-program
pub mod config {
    pub mod program {
